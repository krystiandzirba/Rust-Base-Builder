...
//Component ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
//Component This component applies post-processing effects to the canvas scene and all 3D objects.
//Component ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    <>
      <Suspense fallback={null}>
        <EffectComposer multisampling={antialiasing_state ? 3 : 0}>
          <N8AO aoRadius={ssao_state && page_mode !== "edit" ? 27.5 : 0} distanceFalloff={0.15} intensity={ssao_state && page_mode !== "edit" ? 5 : 0.01} screenSpaceRadius halfRes={true}/>
          <Bloom intensity={bloom_state ? 0.5 : 0} luminanceThreshold={0.6} luminanceSmoothing={1} mipmapBlur={true} radius={0.4}/>
