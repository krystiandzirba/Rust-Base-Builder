...
export default function ResourceCounter() {
  ...
  function CountBuildCost(models: string[]) {
    ...
    const stone_models_cost_mapping: { [key: string]: number } = {
      ...
      StoneWallHigh: 300,
      StoneWallMid: 300,
      StoneRoofWallLeft: 300,
      StoneRoofWallRight: 300,
    ...
    const metal_models_cost_mapping: { [key: string]: number } = {
      ...
      MetalWallHigh: 200,
      MetalWallMid: 200,
      MetalRoofWallLeft: 200,
      MetalRoofWallRight: 200,
    ...
    const armored_models_cost_mapping: { [key: string]: number } = {
      ...
      ArmoredWallHigh: 25,
      ArmoredWallMid: 25,
      ArmoredRoofWallLeft: 25,
      ArmoredRoofWallRight: 25,
    ...
    const upgrade_from_wood_model_cost: { [key: string]: number } = {
      ...
      StoneWallHigh: 50,
      StoneWallMid: 50,
      StoneRoofWallLeft: 50,
      StoneRoofWallRight: 50,
