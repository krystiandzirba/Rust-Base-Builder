...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/armored_floor_frame_triangle_textured.glb") as GLTFResult;
...
useGLTF.preload("./models/armored_floor_frame_triangle_textured.glb");
