...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/strenghtened_glass_window_textured.glb") as GLTFResult;
...
useGLTF.preload("./models/strenghtened_glass_window_textured.glb");
