...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/metal/metal_foundation_square_high_textured.glb") as GLTFResult;
          ...
          >
            {enable_model_textures && page_mode === "edit" && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Metal square foundation (high)", "upgradeable", "downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/metal/metal_foundation_square_high_textured.glb");
Model.displayName = "MetalFoundationSquareHigh";
