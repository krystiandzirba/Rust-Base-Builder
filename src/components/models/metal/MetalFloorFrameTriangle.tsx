...
type GLTFResult = GLTF & {
  ...
  materials: {["Material.019"]: THREE.MeshStandardMaterial}}; //prettier-ignore
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/metal/metal_floor_frame_triangle_textured.glb") as GLTFResult;
      ...
      {frames_active && !model_destroyed && (
        <group {...props} dispose={null}>
          <mesh
            ...
            {...defaultMeshMaterial(materials["Material.019"])}
          ...
          >
            {(!enable_model_textures || page_mode === "edit") && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Metal floor frame (triangle)", "upgradeable", "downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/metal/metal_floor_frame_triangle_textured.glb");
Model.displayName = "MetalFloorFrameTriangle";
