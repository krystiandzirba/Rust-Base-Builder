...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/metal/metal_floor_square_textured.glb") as GLTFResult;
          ...
          >
            {enable_model_textures && page_mode === "edit" && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Metal floor (square)", "upgradeable", "downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/metal/metal_floor_square_textured.glb");
Model.displayName = "MetalFloorSquare";
