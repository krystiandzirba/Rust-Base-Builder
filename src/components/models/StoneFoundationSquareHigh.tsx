...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/stone_foundation_square_high_textured.glb") as GLTFResult;
...
useGLTF.preload("./models/stone_foundation_square_high_textured.glb");
