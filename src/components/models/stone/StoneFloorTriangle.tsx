...
type GLTFResult = GLTF & {
  ...
  materials: {["Material.015"]: THREE.MeshStandardMaterial}}; //prettier-ignore
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/stone/stone_floor_triangle_textured.glb") as GLTFResult;
      ...
      {floors_active && !model_destroyed && (
        <group {...props} dispose={null}>
          <mesh
            ...
            {...defaultMeshMaterial(materials["Material.015"])}
          ...
          >
            {(!enable_model_textures || page_mode === "edit") && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Stone floor (triangle)", "upgradeable", "non-downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/stone/stone_floor_triangle_textured.glb");
Model.displayName = "StoneFloorTriangle";
