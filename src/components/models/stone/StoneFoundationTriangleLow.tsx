...
type GLTFResult = GLTF & {
  ...
  materials: {["Material.009"]: THREE.MeshStandardMaterial}}; //prettier-ignore
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/stone/stone_foundation_triangle_low_textured.glb") as GLTFResult;
      ...
      {foundations_active && !model_destroyed && (
        <group {...props} dispose={null}>
          <mesh
            ...
            {...defaultMeshMaterial(materials["Material.009"])}
          ...
          >
            {enable_model_textures && page_mode === "edit" && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Stone triangle foundation (low)", "upgradeable", "non-downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/stone/stone_foundation_triangle_low_textured.glb");
Model.displayName = "StoneFoundationTriangleLow";
