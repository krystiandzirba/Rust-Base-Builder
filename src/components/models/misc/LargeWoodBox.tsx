...
type GLTFResult = GLTF & {
  nodes: {Cube004: THREE.Mesh}; //prettier-ignore
  materials: {["Material.068"]: THREE.MeshStandardMaterial}}; //prettier-ignore
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/misc/large_wood_box_textured.glb") as GLTFResult;
      ...
      {miscs_active && !model_destroyed && (
        <group {...props} dispose={null}>
          <mesh
            ...
            {...defaultMeshMaterial(materials["Material.068"])}
          ...
          >
            {(!enable_model_textures || page_mode === "edit") && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Large box", "non-upgradeable", "non-downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/misc/large_wood_box_textured.glb");
