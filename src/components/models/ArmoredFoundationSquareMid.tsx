...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/armored_foundation_square_mid_textured.glb") as GLTFResult;
...
useGLTF.preload("./models/armored_foundation_square_mid_textured.glb");
