...
type GLTFResult = GLTF & {
  ...
  materials: {["Material.057"]: THREE.MeshStandardMaterial}}; //prettier-ignore
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/windows/metal_vertical_embrasure_textured.glb") as GLTFResult;
      ...
      {walls_active && !model_destroyed && (
        <group {...props} dispose={null}>
          <mesh
            ...
            {...defaultMeshMaterial(materials["Material.057"])}
          ...
          >
            {(!enable_model_textures || page_mode === "edit") && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Metal vertical embrasure", "non-upgradeable", "non-downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/windows/metal_vertical_embrasure_textured.glb");
Model.displayName = "MetalVerticalEmbrasure";
