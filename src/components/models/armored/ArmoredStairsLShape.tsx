...
type GLTFResult = GLTF & {
  ...
  materials: {["Material.040"]: THREE.MeshStandardMaterial}}; //prettier-ignore
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/armored/armored_stairs_l_shape_textured.glb") as GLTFResult;
      ...
      {stairs_active && !model_destroyed && (
        <group {...props} dispose={null}>
          <mesh
            ...
            {...defaultMeshMaterial(materials["Material.040"])}
          ...
          >
            {(!enable_model_textures || page_mode === "edit") && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Armored stairs (L-shape)", "non-upgradeable", "downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/armored/armored_stairs_l_shape_textured.glb");
Model.displayName = "ArmoredStairsLShape";
