...
type GLTFResult = GLTF & {
  ...
  materials: {["Material.044"]: THREE.MeshStandardMaterial}}; //prettier-ignore
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/armored/armored_floor_frame_square_textured.glb") as GLTFResult;
      ...
      {frames_active && !model_destroyed && (
        <group {...props} dispose={null}>
          <mesh
            ...
            {...defaultMeshMaterial(materials["Material.044"])}
          ...
          >
            {(!enable_model_textures || page_mode === "edit") && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Armored floor frame (square)", "non-upgradeable", "downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/armored/armored_floor_frame_square_textured.glb");
Model.displayName = "ArmoredFloorFrameSquare";
