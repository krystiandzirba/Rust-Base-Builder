...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/armored/armored_roof_wall_right_textured.glb") as GLTFResult;
          ...
          >
            {(!enable_model_textures || page_mode === "edit") && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Armored roof wall (right)", "non-upgradeable", "downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/armored/armored_roof_wall_right_textured.glb");
Model.displayName = "ArmoredRoofWallRight";
