...
type GLTFResult = GLTF & {
  ...
  materials: {["Material.026"]: THREE.MeshStandardMaterial}}; //prettier-ignore
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/armored/armored_foundation_square_low_textured.glb") as GLTFResult;
      ...
      {foundations_active && !model_destroyed && (
        <group {...props} dispose={null}>
          <mesh
            ...
            {...defaultMeshMaterial(materials["Material.026"])}
          ...
          >
            {enable_model_textures && page_mode === "edit" && (
              <>
                ...
                />
                {meshEdgesVisibility}
                {meshAnnotationVisibility(["Armored square foundation (low)", "non-upgradeable", "downgradeable"])}
              </>
            )}
          </mesh>
        </group>
...
useGLTF.preload("./models/armored/armored_foundation_square_low_textured.glb");
Model.displayName = "ArmoredFoundationSquareLow";
