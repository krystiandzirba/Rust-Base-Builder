...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/metal_foundation_triangle_mid_textured.glb") as GLTFResult;
...
useGLTF.preload("./models/metal_foundation_triangle_mid_textured.glb");
