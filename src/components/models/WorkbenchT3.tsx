...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { nodes, materials } = useGLTF("./models/workbench_t3_textured.glb") as GLTFResult;
  ...
  const ModelMaterialColor = () => {
    if (!model_creation_state && enable_model_material) {
      return model_selected ? "#f5b784" : model_hover ? "#ff845e" : "#9c754f";
...
useGLTF.preload("./models/workbench_t3_textured.glb");
